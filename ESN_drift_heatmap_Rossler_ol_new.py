    ...
    for k in range(len(noise)): #noise scan    
        for idx in range(trials_esn): #trials of different ESN realizations
            ...
            for j in range(trials_noise): #trials of different noise realizations
                ...
                X_d=forward_rnn_drift_new(params, ut_train1, seed_noise[j],None,False,None,std_drift,std_noise)
                ...
                X_d_C_ctc=forward_rnn_drift_new(params, ut_train1, seed_noise[j],None,False,C_ctc,std_drift,std_noise)
                ...
                X_d_C_id=forward_rnn_drift_new(params, ut_train1, seed_noise[j],None,False,C_id,std_drift,std_noise)
                ...
                X_d_C_noi=forward_rnn_drift_new(params, ut_train1, seed_noise[j],None,False,C_noi,std_drift,std_noise)
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(f"plots/newNRMSE_NoC_heatmap_N{N}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.png", dpi=300, bbox_inches='tight')
plt.savefig(f"plots/newNRMSE_NoC_heatmap_N{N}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.pdf", dpi=300, bbox_inches='tight')
plt.show()
...
# ax.invert_yaxis()
# plt.tight_layout()
# plt.savefig(f"plots/newNRMSE_C_noisy_heatmapN{N}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.png", dpi=300, bbox_inches='tight')
# plt.show()
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(f"plots/newNRMSE_CTC_heatmap_N{N}_m{m}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.png", dpi=300, bbox_inches='tight')
plt.savefig(f"plots/newNRMSE_CTC_heatmap_N{N}_m{m}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.pdf", dpi=300, bbox_inches='tight')
plt.show()
...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig(f"plots/newNRMSE_Ideal_heatmap_N{N}_trials{trials}_noisestep{args.noise_step}_maxnoise{args.noise_max}_bstep{args.b_steps}_maxb{args.b_max}_a{a}_steps{steps}_anew{a_new}_traintime{time_len}_inf{inff}_sup{supf}.png", dpi=300, bbox_inches='tight')
plt.show()
